...
- 当前基线：2124 tests / 0 fail（2026-08-08 核实，stableContext 长度契约 +2 与端清单术语簇 +7；此前 2115 = 同日 `6c8ebae` retriever 惰性初始化分派修复 +3，2112 停在 08-06，2110 停在 08-04 pivot-apply 专用写入通道 +14，再往前 2096 = B 段 pivot-distill 修复批新增、2013 停在 07-30）
